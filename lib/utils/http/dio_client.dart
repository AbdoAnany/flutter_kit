...
import 'package:flutter_kit/utils/error/failure.dart';
import 'package:flutter_kit/utils/http/url.dart';
...
var r=Either<Failure, Map<String, dynamic>>;
  ...
  static Future<Either<Failure, Map<String, dynamic>>> get(String endpoint,{String? token,String? store}) async {
    try {
  ...
  static Future<Either<Failure, Map<String, dynamic>>> post(String endpoint, dynamic data,{String? token,String? store}) async {
    try {
      responseHandler(token: token,store: store);
  ...
  static Future<Either<Failure, Map<String, dynamic>>> put(String endpoint, dynamic data,{String? token,String? store}) async {
    try {
      responseHandler(token: token,store: store);
  ...
  static Future<Either<Failure, Map<String, dynamic>>> delete(String endpoint,{String? token,String? store}) async {
    try {
      responseHandler(token: token,store: store);
  ...
  static  Either<Failure, T> _handleResponse<T>(Response response) {
    ...
    if (response.statusCode == 200) {
      ...
      final errorMessage = 'Error occurred with status code: ${response.statusCode}';
