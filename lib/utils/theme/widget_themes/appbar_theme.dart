...
class TAppBarTheme{
  ...
  static AppBarTheme  lightAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: TSizes.fontSizeLg, fontWeight: FontWeight.w600, color: AppColor.black),
  );
  static AppBarTheme darkAppBarTheme = AppBarTheme(
    ...
    titleTextStyle: TextStyle(fontSize: TSizes.fontSizeLg, fontWeight: FontWeight.w600, color: AppColor.white),
  );
}