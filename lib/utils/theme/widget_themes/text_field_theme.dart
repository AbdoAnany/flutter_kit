...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeMd, color: AppColor.black),
    hintStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeSm, color: AppColor.black),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeMd, color: AppColor.white),
    hintStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeSm, color: AppColor.white),
